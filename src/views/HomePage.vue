...
export default {
  ...
  data() {
    return {
      ...
      clients: [
        { name: 'Mauritel' , logo: '/logos/clients/mauritel.webp' },
        { name: 'Chinguitel' , logo: '/logos/clients/Chinguitel.webp' },
        { name: 'Mattel' , logo: '/logos/clients/mattel.webp' },
        { name: 'ARE' , logo: '/logos/clients/ARE.webp' },
        { name: 'CNAM' , logo: '/logos/clients/cnam.webp' },
        { name: 'SNIM' , logo: '/logos/clients/snim.webp' },
        { name: 'Faculté de Médecine' , logo: '/logos/clients/UNA.webp' },
        { name: 'Faculté des Sciences et Techniques' , logo: '/logos/clients/UNA.webp' },
        { name: 'INSP' , logo: '/logos/clients/INSP.webp' },
        { name: 'SOMIR' , logo: '/logos/clients/somir.webp' },
        { name: 'COMMECA' , logo: '/logos/clients/comeca.webp' },
        { name: 'CSS' , logo: '/logos/clients/CSS.webp' },
        { name: 'CSA Bassiknou' , logo: '/logos/clients/CSA.webp' },
        { name: 'OPM' , logo: '/logos/clients/OPM.webp' },
        { name: 'ONSER' , logo: '/logos/clients/onser.webp' },
        { name: 'PAN' , logo: '/logos/clients/PAN.webp' },
      ],
      partners: [
        { name: 'MikroTik', logo :'/logos/partenaires/Mikrotik.webp'},
        { name: 'Teltonika', logo :'/logos/partenaires/TELTONIKA.webp'},
        { name: 'LigoWave', logo :'/logos/partenaires/ligowave.webp'},
        { name: 'INOCOD', logo :'/logos/partenaires/inocod.webp' },
        { name: 'Zimbra', logo :'/logos/partenaires/Zimbra.webp'},
        { name: 'ControlCall', logo :'/logos/partenaires/ControlCall.webp'},
      ],
    }
  },
}
