  ...
  <div class="bg-white min-h-screen">
    ...
    <section class="bg-sky-800 py-24">
      <div class="max-w-7xl mx-auto px-6 lg:px-10 flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <RouterLink
          to="/contact"
          class="flex-shrink-0 px-8 py-4 rounded-xl g-sky-700 text-white border border-white/30  font-bold hover:bg-sky-600 hover:text-slate-950 transition-colors text-lg"
        >
          Contactez-nous →
        </RouterLink>
      </div>
